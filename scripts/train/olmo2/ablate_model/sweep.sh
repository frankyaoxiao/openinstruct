...
accelerate launch \
    ...
    --exclude_chosen_models internlm/internlm2_5-20b-chat google/gemma-2-27b-it google/gemma-2-9b-it internlm/internlm2_5-7b-chat \
    --add_seed_and_date_to_exp_name False \
    --do_not_randomize_output_dir True \
    --with_tracking \
    --output_dir output/olmo2_7b_dpo_ablate_model
